...
extern "C" {
	...
	void evma_set_tls_parms (const unsigned long binding, const char *privatekey_filename, const char *certchain_filenane, const char *dhparams_filename, int verify_peer, int ssl_version, const char *cipherlist);
	void evma_set_tls_host_cert (const unsigned long binding, const char *hostname, const char *privatekey_filename, const char *certchain_filename, const char *dhparams_filename, const char *cipherlist);
